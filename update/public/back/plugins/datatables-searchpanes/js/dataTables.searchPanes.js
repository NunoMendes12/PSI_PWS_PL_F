...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
        ...
        /**
         * Adjusts the layoutBo of the top row when the screen is resized
         */
        ...
        /**
         * Resizes the pane based on the layoutBo that is passed in
         *
         * @param layout the layoutBo to be applied to this pane
         */
    ...
    var SearchPanes = /** @class */ (function () {
        ...
        SearchPanes.prototype.resizePanes = function () {
            if (this.c.layout === 'auto') {
                ...
                for (var _b = 0, _c = this.s.panes; _b < _c.length; _b++) {
                    var pane = _c[_b];
                    // Resize the pane with the new layoutBo
                    if (pane.s.displayed) {
        ...
        SearchPanes.prototype._startup = function (table) {
            ...
            // If the layoutBo is set to auto then the panes need to be resized to their best fit
            if (this.c.layout === 'auto') {
                this.resizePanes();
            }
