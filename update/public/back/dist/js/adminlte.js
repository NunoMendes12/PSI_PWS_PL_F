...
(function (global, factory) {
  ...
  var CLASS_NAME_LAYOUT_FIXED$1 = 'layoutBo-fixed';
  var CLASS_NAME_NAVBAR_FIXED = 'layoutBo-navbar-fixed';
  var CLASS_NAME_NAVBAR_SM_FIXED = 'layoutBo-sm-navbar-fixed';
  var CLASS_NAME_NAVBAR_MD_FIXED = 'layoutBo-md-navbar-fixed';
  var CLASS_NAME_NAVBAR_LG_FIXED = 'layoutBo-lg-navbar-fixed';
  var CLASS_NAME_NAVBAR_XL_FIXED = 'layoutBo-xl-navbar-fixed';
  var CLASS_NAME_FOOTER_FIXED = 'layoutBo-footer-fixed';
  var CLASS_NAME_FOOTER_SM_FIXED = 'layoutBo-sm-footer-fixed';
  var CLASS_NAME_FOOTER_MD_FIXED = 'layoutBo-md-footer-fixed';
  var CLASS_NAME_FOOTER_LG_FIXED = 'layoutBo-lg-footer-fixed';
  var CLASS_NAME_FOOTER_XL_FIXED = 'layoutBo-xl-footer-fixed';
  var Default$a = {
  ...
  var CLASS_NAME_LAYOUT_FIXED = 'layoutBo-fixed';
