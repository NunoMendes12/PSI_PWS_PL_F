...
const CLASS_NAME_NAVBAR_FIXED = 'layoutBo-navbar-fixed'
const CLASS_NAME_NAVBAR_SM_FIXED = 'layoutBo-sm-navbar-fixed'
const CLASS_NAME_NAVBAR_MD_FIXED = 'layoutBo-md-navbar-fixed'
const CLASS_NAME_NAVBAR_LG_FIXED = 'layoutBo-lg-navbar-fixed'
const CLASS_NAME_NAVBAR_XL_FIXED = 'layoutBo-xl-navbar-fixed'
const CLASS_NAME_FOOTER_FIXED = 'layoutBo-footer-fixed'
const CLASS_NAME_FOOTER_SM_FIXED = 'layoutBo-sm-footer-fixed'
const CLASS_NAME_FOOTER_MD_FIXED = 'layoutBo-md-footer-fixed'
const CLASS_NAME_FOOTER_LG_FIXED = 'layoutBo-lg-footer-fixed'
const CLASS_NAME_FOOTER_XL_FIXED = 'layoutBo-xl-footer-fixed'
